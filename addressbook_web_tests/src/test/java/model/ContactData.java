...
public record ContactData(String FirstName, String MiddleName, String LastName, //String Nickname, String Photo, String Title, String Company, String Address,
    ...
    public ContactData withFirstName(String FirstName){
        return new ContactData(FirstName, this.MiddleName, this.LastName, //this.Nickname, this.Photo, this.Title, this.Company, this.Address,
